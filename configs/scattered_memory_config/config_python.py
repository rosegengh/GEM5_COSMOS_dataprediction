...
#parser.add_argument('--options', default="", help='The options for the binary to run')
parser = argparse.ArgumentParser(description="gem5 simulation config")
parser.add_argument('--cmd', type=str, help='Specifies the command to run on the simulated system')
parser.add_argument('--options', type=str, help='Specifies the options for the command', default="")
